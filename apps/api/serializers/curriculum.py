...
class LessonSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Lesson
        fields = [
            'id', 'unit_id', 'course_id', 'title', 'objective',
            'estimated_minutes', 'order_index', 'is_published',
            'enabling_objectives', 'content_status', 'content_quality',
            'allow_group_mode', 'max_group_size', 'group_requires_approval',
        ]
