...
from apps.tutoring.simple_tutor.engine import _is_offline_session
from apps.tutoring.simple_tutor.model_choice import LOCAL_PROVIDER
...
class OfflineSessionPredicateTest(SimpleTestCase):
    ...
    def test_a_lookup_failure_defaults_to_online(self):
        ...
        with patch(
            'apps.tutoring.simple_tutor.model_choice.resolve_for_session',
