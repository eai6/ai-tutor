...
_SYSTEM = (
    ...
    "do not-X\n"
    "  - SCAFFOLD-vs-POSED MISMATCH: the tutor's scaffolding equation "
    "uses different numbers than the posed bank/practice question. "
    "Example to catch: posed problem says \"x + 15 = 40\" (answer 25), "
    "but tutor's scaffold then says \"To solve x + 15 = 25, what "
    "operation should you apply?\" — the tutor swapped the result (40) "
    "for the answer (25). Flag as: \"scaffold equation contradicts "
    "posed problem: <scaffold_eq> vs <posed_eq>\".\n"
