...
The full technical reference: architecture, every Django app, configuration,
the content pipeline, deployment, the Jetson kiosk, routes and testing.

For getting a deployment running, start with [the README](../README.md) or
[the self-hosting manual](self-hosting.md). This document is the detail behind
them, and it assumes you have the source.
