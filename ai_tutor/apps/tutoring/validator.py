...
from ai_tutor.apps.tutoring.praise_filter import strip_praise_if_wrong, _PRAISE_RE
from ai_tutor.apps.tutoring.fact_verifier import verify_response, FactCheckResult
...
def validate_tutor_response(
    ...
    #
    # Preferred path: caller already ran ai_tutor.apps.tutoring.combined_judge,
