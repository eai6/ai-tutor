...
class TestR5RemediationWiring(BaseTutoringTestCase):
    ...
    def test_start_remediation_calls_remediation_service(self, mock_gen):
        ...
        with patch('ai_tutor.apps.tutoring.personalization.RemediationService') as mock_svc_cls:
            mock_svc = MagicMock()
    ...
    def test_remediation_state_loads_from_engine_state(self):
        ...
        from ai_tutor.apps.tutoring.conversational_tutor import ConversationalTutor, SessionState
