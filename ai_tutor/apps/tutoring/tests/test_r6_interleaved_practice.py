...
class TestR6InterleavedPractice(BaseTutoringTestCase):
    ...
    @patch('ai_tutor.apps.tutoring.personalization.InterleavedPracticeService')
    ...
    def test_interleaved_block_graceful_on_error(self):
        ...
        with patch('ai_tutor.apps.tutoring.personalization.InterleavedPracticeService') as mock_cls:
