...
class TestR7PrerequisiteGating(BaseTutoringTestCase):
    ...
    def test_check_prerequisites_met(self):
        ...
        from ai_tutor.apps.tutoring.views import check_lesson_prerequisites
    ...
    def test_check_prerequisites_fails_open(self):
        ...
        with patch('ai_tutor.apps.tutoring.views.check_lesson_prerequisites.__module__'):
            # Force an import error by patching the model import
            with patch('ai_tutor.apps.tutoring.skills_models.LessonPrerequisite.objects') as mock_qs:
