...
class TestR3R4SessionPersonalization(BaseTutoringTestCase):
    ...
    @patch('ai_tutor.apps.tutoring.personalization.SessionPersonalizationService')
    def test_load_personalization_calls_service(self, mock_svc_cls):
        ...
        from ai_tutor.apps.tutoring.conversational_tutor import ConversationalTutor
        from ai_tutor.apps.tutoring.personalization import SessionPersonalization
    ...
    @patch('ai_tutor.apps.tutoring.conversational_tutor.ConversationalTutor._generate_response')
    @patch('ai_tutor.apps.tutoring.conversational_tutor.ConversationalTutor._load_personalization')
