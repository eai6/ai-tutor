...
from ai_tutor.apps.tutoring.cli.session import BootstrapError, subject_filter
...
class StreamPrinterTest(SimpleTestCase):
    ...
    def _printer(self):
        from ai_tutor.apps.tutoring.management.commands.tutor_chat import _StreamPrinter
