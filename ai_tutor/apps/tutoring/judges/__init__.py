...
from ai_tutor.apps.tutoring.judges.arithmetic import (
    ArithmeticResult,
...
from ai_tutor.apps.tutoring.judges.handoff import (
    HandoffResult,
    run_handoff_judge,
)
from ai_tutor.apps.tutoring.judges.factual import FactualResult, run_factual_judge
from ai_tutor.apps.tutoring.judges.figure_ref import (
    FigureRefResult,
...
from ai_tutor.apps.tutoring.judges.rule import RuleResult, run_rule_judge
from ai_tutor.apps.tutoring.judges.safety import SafetyResult, run_safety_judge
from ai_tutor.apps.tutoring.judges.step_eval import StepEvalResult, run_step_eval_judge
...
def run_all_judges(
    ...
    *,
    ...
    # See ai_tutor.apps.tutoring.tracing + Phase 1 of
