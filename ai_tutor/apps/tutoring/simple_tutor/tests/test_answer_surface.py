...
from ai_tutor.apps.tutoring.simple_tutor.tools import _resolve_student_choice
...
class RemediationPickerRepaintTest(DjangoTestCase):
    ...
    def test_failed_ticket_repaints_the_picker_to_the_remediation_question(self):
        from ai_tutor.apps.tutoring.simple_tutor.exit_ticket import submit_exit_ticket
...
class EveryPayloadBuilderCarriesAnswerChoicesTest(SimpleTestCase):
    ...
    def _builders(self):
        ...
        import ai_tutor.apps.tutoring.simple_tutor as _pkg
...
class ServerPicksTheModeTest(SimpleTestCase):
    ...
    def _mode(self, slot, intent, review=None):
        from ai_tutor.apps.tutoring.simple_tutor.prompts import _render_active_mode
    ...
    def test_production_still_carries_all_four_in_block_0(self):
        ...
        from ai_tutor.apps.tutoring.simple_tutor.prompts import build_system_prompt
        blocks, _ = build_system_prompt(
...
class RecentTurnsTrimTest(SimpleTestCase):
    ...
    def test_the_hand_off_tail_is_dropped(self):
        from ai_tutor.apps.tutoring.simple_tutor.prompts import _render_recent_turns_block
    ...
    def test_it_cuts_on_a_sentence_boundary(self):
        ...
        from ai_tutor.apps.tutoring.simple_tutor.prompts import _trim_tutor_turn
