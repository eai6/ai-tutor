...
from ai_tutor.apps.curriculum.models import Lesson, LessonStep, Course
from ai_tutor.apps.llm.models import PromptPack, ModelConfig
...
class SessionTurn(models.Model):
    ...
    # Per-judge breakdown from combined_judge (populated on tutor turns
    # only, when the combined judge ran). Structured shape: step_eval,
    # arithmetic, factual, rule, coherence, figure_ref, figure_vision,
    # safety. Powers the benchmark evaluation tooling — labels like
    # AUTHORED_QUESTION, INCOHERENT, FIGURE_MISMATCH auto-populate from
    # this column at export time. See memory/eval_benchmark_v2_simplified.md.
...
class InFlightQuestion(models.Model):
    ...
    question_type = models.CharField(
        ...
        help_text="Selects the grading tier in ai_tutor.apps.tutoring.simple_tutor.grader.",
    )
...
from ai_tutor.apps.tutoring.skills_models import (  # noqa: E402, F401
    Skill,
    LessonPrerequisite,
    StudentSkillMastery,
    SkillPracticeLog,
