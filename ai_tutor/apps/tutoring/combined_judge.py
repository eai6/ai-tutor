...
Replaces three separate LLM calls per turn with one:
  - ai_tutor.apps.tutoring.llm_arithmetic_verifier.verify_arithmetic_claims
  - ai_tutor.apps.tutoring.fact_verifier.verify_response
  - ai_tutor.apps.tutoring.rule_compliance.check_rule_compliance
...
from ai_tutor.apps.tutoring.llm_arithmetic_verifier import _HAS_NUMBER_RE
...
def run_combined_judge(
    ...
    *,
    ...
    judges in ai_tutor.apps.tutoring.judges.
    ...
    if _use_unified_judge():
        from ai_tutor.apps.tutoring.judges.unified import run_unified_judge
