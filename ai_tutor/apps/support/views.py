...
from ai_tutor.apps.support import services as svc
from ai_tutor.apps.support import tools as tool_catalog
from ai_tutor.apps.support.models import HelpAssistantConversation, HelpAssistantMessage
