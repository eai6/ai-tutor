...
from ai_tutor.apps.curriculum import curriculum_pack as CP
from ai_tutor.apps.curriculum.models import Course, Lesson, Unit
from ai_tutor.apps.desktop.packs import PackError
...
class TestTheImportersRefuseEachOther:
    ...
    def _desktop_pack(self, tmp_path, school):
        from ai_tutor.apps.desktop.packs import build_pack
    ...
    def test_a_curriculum_pack_cannot_provision_a_device(
        ...
        from ai_tutor.apps.desktop.packs import import_pack
