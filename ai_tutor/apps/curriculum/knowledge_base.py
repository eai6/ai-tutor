...
class CurriculumKnowledgeBase:
    ...
    def index_curriculum_document(
        ...
        """
        from ai_tutor.apps.curriculum.curriculum_parser import extract_text_from_file
        ...
        if file_path.lower().endswith('.pdf'):
            try:
                from ai_tutor.apps.curriculum.curriculum_parser import extract_figures_from_pdf
    ...
    def _index_chunks(self, chunks: List[CurriculumChunk]) -> Dict:
        ...
        from ai_tutor.apps.curriculum.kb_storage import upsert_chunks
    ...
    def query_for_figure_descriptions(
        ...
        from ai_tutor.apps.curriculum.kb_storage import query_chunks
    ...
    def get_collection_stats(self) -> Dict:
        ...
        from ai_tutor.apps.curriculum.kb_storage import collection_stats
    ...
    def clear_collection(self):
        ...
        if not self._storage_available:
            return
        from ai_tutor.apps.curriculum.kb_storage import clear_institution
