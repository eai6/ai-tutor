...
Return ONLY valid JSON."""
    ...
    try:
        from ai_tutor.apps.curriculum.content_generator import _instructor_structured_call
        from ai_tutor.apps.curriculum.content_gen_schemas import ExtractedCompetencyList
