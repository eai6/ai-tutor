...
def run_step_regen(
    *,
    ...
    from ai_tutor.apps.curriculum.content_regen.score import score_candidate
...
def run_exit_question_regen(
    *,
    ...
    from ai_tutor.apps.curriculum.content_regen.score import score_candidate
    from ai_tutor.apps.curriculum.content_regen.schemas import MCQRewrite
...
def run_fill_in_blank_regen(
    *,
    ...
    """
    from ai_tutor.apps.curriculum.content_judges.fill_in_blank import run_fill_in_blank_judge
    from ai_tutor.apps.curriculum.content_regen.prompt import build_fib_auto_regen_prompt
    from ai_tutor.apps.curriculum.content_regen.schemas import FillInBlankRewrite
...
def run_short_answer_regen(
    *,
    ...
    """
    from ai_tutor.apps.curriculum.content_judges.short_answer import run_short_answer_judge
    from ai_tutor.apps.curriculum.content_regen.prompt import build_sa_auto_regen_prompt
    from ai_tutor.apps.curriculum.content_regen.schemas import ShortAnswerRewrite
    return _typed_question_regen_loop(
        original_question=original_question,
        judge_result=judge_result,
        lesson=lesson,
...
def run_matching_regen(
    *,
    ...
    OR cycle cap hit.
    """
    from ai_tutor.apps.curriculum.content_judges.matching import run_matching_judge
    from ai_tutor.apps.curriculum.content_regen.prompt import build_match_auto_regen_prompt
    from ai_tutor.apps.curriculum.content_regen.schemas import MatchingRewrite
    return _typed_question_regen_loop(
        original_question=original_question,
        judge_result=judge_result,
        lesson=lesson,
