...
def _extract_pdf_with_vision(
    ...
    from ai_tutor.apps.curriculum.vision_ocr import (
        RenderedPage,
...
Return ONLY valid JSON."""
    ...
    from ai_tutor.apps.curriculum.utils import determine_cycles, parse_grade_level_string
...
def parse_mathematics_curriculum(text: str, grade_level: str = "S1") -> ParsedCurriculum:
    ...
    """
    import re as _re
    from ai_tutor.apps.curriculum.utils import determine_cycles
    cycles = determine_cycles(grade_level)
    cycle = "/".join(cycles)
