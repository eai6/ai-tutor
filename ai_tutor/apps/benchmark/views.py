...
def benchmark_export_jsonl(request):
    ...
    from ai_tutor.apps.benchmark.bea_mapping import map_to_bea_2025
    from ai_tutor.apps.benchmark.hydration import (
...
from ai_tutor.apps.benchmark import session_sampling as S_sampling
from ai_tutor.apps.benchmark.models import SessionEvalAnnotation, SessionEvalItem
...
def session_eval_list(request):
    ...
    from ai_tutor.apps.benchmark.models import SessionSampleRun
...
def session_eval_scores(request):
    ...
    from ai_tutor.apps.benchmark import session_scoring as SS
