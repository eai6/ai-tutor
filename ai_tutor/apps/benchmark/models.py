...
from ai_tutor.apps.benchmark.labels import (
    ALL_LABELS,
    ACTION_LABELS,
    ISSUE_LABELS,
    FAILURE_CATEGORIES,
)
from ai_tutor.apps.benchmark.pedagogy import choices_for as _pedagogy_choices
...
class BenchmarkAnnotation(models.Model):
    ...
    actual_labels = models.JSONField(
        ...
        help_text="Multi-select labels describing what the production "
                  ...
                  "ai_tutor.apps.benchmark.labels.ALL_LABELS.",
    )
    ...
    failure_categories = models.JSONField(
        ...
        help_text="List of cluster tags from "
                  "ai_tutor.apps.benchmark.labels.FAILURE_CATEGORIES. Multiple may "
