...
from ai_tutor.apps.api.serializers.tutoring import TutorSessionSerializer
...
def start_session(request):
    ...
    from ai_tutor.apps.tutoring.models import StudentLessonProgress, SessionParticipant
    from ai_tutor.apps.tutoring.views import _try_add_participant
