...
from ai_tutor.apps.api.views import auth as auth_views
from ai_tutor.apps.api.views import resources as resource_views
from ai_tutor.apps.api.views import sessions as session_views
from ai_tutor.apps.api.views import offline_pack as offline_views
from ai_tutor.apps.api.views import mobile_models as mobile_model_views
from ai_tutor.apps.api.views import sync as sync_views
from ai_tutor.apps.api.views import devices
