...
from ai_tutor.apps.curriculum.curriculum_parser import OCRFailure
...
def extract_material_with_vision(
    ...
    # of dropping them.
    from ai_tutor.apps.curriculum.curriculum_parser import _render_page_within_b64_limit
    page_images = []
    for page in doc:
...
def _index_vision_data(upload, vision_data: list):
    ...
    import json
    from ai_tutor.apps.accounts.models import Institution
    from ai_tutor.apps.curriculum.knowledge_base import CurriculumKnowledgeBase, CurriculumChunk
