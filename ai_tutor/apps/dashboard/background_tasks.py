...
Return ONLY the JSON array, no other text."""
            ...
            from ai_tutor.apps.curriculum.content_generator import _instructor_generate_exit_ticket
...
def generate_complete_lesson(lesson_id: int, institution_id: int, log_fn=None):
    ...
    from ai_tutor.apps.curriculum.models import Lesson as _LessonModel
