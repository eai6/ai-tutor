"""Generate offline_eval/colab_multiturn_fixcheck.ipynb — a Colab notebook that
runs the MULTI-TURN eval on the top-6 sweep-3 models at a 5-scenario sample.
...
REPO = 'eai6/ai-tutor'
BRANCH = 'pixeldesignlabs-dev-portuguese'   # MUST carry the post-sweep-2 fixes
...
out = Path(__file__).resolve().parent / 'colab_multiturn_fixcheck.ipynb'
